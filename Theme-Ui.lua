...
local ClosureBindings = {
	...
	return {
		...
		TitleBarLine = Color3.fromRGB(10, 10, 10),
		Tab = Color3.fromRGB(190, 30, 30),

		Element = Color3.fromRGB(40, 40, 40),
		ElementBorder = Color3.fromRGB(18, 0, 0),
		InElementBorder = Color3.fromRGB(10, 0, 0),
		ElementTransparency = 0.9,

		ToggleSlider = Color3.fromRGB(245, 50, 50),
		ToggleToggled = Color3.fromRGB(25, 25, 25),

		SliderRail = Color3.fromRGB(200, 30, 60),

		DropdownFrame = Color3.fromRGB(50, 10, 10),
		DropdownHolder = Color3.fromRGB(18, 18, 18),
		DropdownBorder = Color3.fromRGB(12, 0, 0),
		DropdownOption = Color3.fromRGB(60, 20, 20),

		Keybind = Color3.fromRGB(22, 22, 22),

		Input = Color3.fromRGB(25, 25, 25),
		InputFocused = Color3.fromRGB(40, 10, 10),
		InputIndicator = Color3.fromRGB(70, 0, 0),

		Dialog = Color3.fromRGB(26, 26, 26),
		DialogHolder = Color3.fromRGB(30, 30, 30),
		DialogHolderLine = Color3.fromRGB(15, 0, 0),
		DialogButton = Color3.fromRGB(50, 10, 10),
		DialogButtonBorder = Color3.fromRGB(25, 0, 0),
		DialogBorder = Color3.fromRGB(120, 0, 0),
		DialogInput = Color3.fromRGB(32, 10, 10),
		DialogInputLine = Color3.fromRGB(13, 0, 0),

		Text = Color3.fromRGB(255, 220, 220),
		SubText = Color3.fromRGB(170, 100, 100),
		Hover = Color3.fromRGB(50, 15, 15),
		HoverChange = 0.05,
	}
end
} 
